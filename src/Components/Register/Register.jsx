...
const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        .then((userCrediantials) => {
          console.log(userCrediantials.user);
        })
        .catch(error => {
    ...
    return (
        <div className="max-w-lg mx-auto m-4 p-4 space-y-6">
            <h4 className='text-4xl font-semibold'>Register</h4>
            <form onSubmit={handleRegister} className="space-y-2 text">
